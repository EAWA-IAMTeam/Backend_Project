...
type PaymentService interface {
	...
	CalculateTotalAmountByOrder(resp *models.Data, transactions []models.LazadaTransaction)
...
func (p *paymentService) CalculateTotalAmountByOrder(resp *models.Data, transactions []models.LazadaTransaction) {
